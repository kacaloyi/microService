...
#生成手机UserAgent
def getPhoneUserAgent():
    return random.choice(user_agent_list)

#生成PC环境UserAgent
def getPcUserAgent():
    return random.choice(pc_user_agent_list)

#测试代码
if __name__ == "__main__":
    # ua = getPhoneUserAgent()
    # check = parse(ua)

    # if  True ==  check.is_mobile:
    #     print(ua)
    #     print(check.device)
    #     print(check.device.family)

    for ua in pc_user_agent_list:
        check = parse(ua)
    ...
    print("finish")
    print(getPhoneUserAgent(),"")
    print(getPcUserAgent(),"")